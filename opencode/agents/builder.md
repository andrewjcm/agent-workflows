---
description: Opt-in implementation agent. May edit files, but only within the scope the user explicitly grants. Use sparingly.
mode: subagent
tools:
  write: true
  edit: true
...
> @coach or @test-designer? You can always come back to me."
